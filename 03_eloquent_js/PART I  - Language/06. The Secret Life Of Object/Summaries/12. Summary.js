//  - Objects do more than just hold their own properties. They have prototypes, which are other objects.
...
//  - One useful thing to do with objects is to specify an interface for them and tell everybody that they are 
//    supposed to talk to your object only through that interface. The rest of the details that make up your 
//    object are now -encapsulated-, hidden behind the interface...

//  - More than one type may implement the same interface. 
//  - Code written to use an interface automatically knows how to work with any number of different objects 
//    that provide the interface. This is called -polymorphism-.

//  - When implementing multiple classes that differ in only some details, it can be helpful to write the
//    new classes as subclasses of an existing class, inheriting part of its behavior.
